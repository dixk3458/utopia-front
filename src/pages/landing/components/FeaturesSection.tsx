...
export default function FeaturesSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="features"
      className="py-8 md:py-12 lg:py-24 bg-gray-50/50"
    >
      ...
      <div className="stagger-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
        {features.map((feature) => (
          <div
            key={feature.id}
            className="hover-lift bg-white p-8 rounded-2xl shadow-[0_2px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100/50 hover:shadow-lg transition-shadow duration-300 flex flex-col items-start text-left will-change-transform"
          >
            <div
