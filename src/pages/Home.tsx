...
import { useNavigate } from 'react-router'; // ✅ Fix: react-router-dom → react-router
...
// ✅ Fix: Header, Sidebar import 제거 (AppShell 레이아웃에서 이미 렌더링됨)
...
export default function Home() {
  ...
  // ✅ Fix: AppShell이 이미 Sidebar + Header를 렌더링하므로 main 콘텐츠만 반환
  return (
    <>
